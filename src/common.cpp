...
bool TUNING = false;
bool verbose = false;
filesystem::path dbname;
bool test_get = true, test_ask = true, test_try = true;
 ...
 */
long get_statm(void) {
    long    total = 0;  // shared, text, lib, data, dt; man proc
#if defined (__linux__)
    long rss = 0;
...
/**
 * @brief Update memory usage counter
 */
...
void out_result(uint64_t dbsize) {
